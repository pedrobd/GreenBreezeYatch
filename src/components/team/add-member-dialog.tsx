    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="sm:max-w-[500px] rounded-3xl border-white/50 bg-white/80 backdrop-blur-2xl shadow-2xl overflow-y-auto max-h-[90vh]">
                <DialogHeader>
                    <DialogTitle className="font-heading text-2xl text-[#0A1F1C]">Registar Colaborador</DialogTitle>
                    <DialogDescription className="font-body text-[#0A1F1C]/60">
                        Adicione os detalhes pessoais e financeiros do novo colaborador.
                    </DialogDescription>
                </DialogHeader>
                <form onSubmit={handleSubmit} className="space-y-4 py-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                            ...
                            <Input
                                id="name"
                                name="name"
                                placeholder="Ex: Pedro Marinheiro"
                                required
                    ...
                    <DialogFooter className="pt-4">
                        ...
                        >
                            {loading ? <Loader2 className="mr-2 h-4 w-4 animate-spin" /> : "Registar Colaborador"}
                        </Button>
                    </DialogFooter>
                </form>
            </DialogContent>
