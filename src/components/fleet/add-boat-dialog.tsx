        ...
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="sm:max-w-[1200px] rounded-3xl border-white/50 bg-white/70 backdrop-blur-2xl shadow-2xl p-8 font-body border max-h-[90vh] overflow-y-auto">
                <DialogHeader className="space-y-3">
                    <DialogTitle className="text-3xl font-bold font-heading text-[#0A1F1C]">Nova Embarcação</DialogTitle>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 pb-4">
                            ...
                            <div className="space-y-6">
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormLabel className="text-[10px] font-black uppercase tracking-widest text-[#0A1F1C]/50">Imagem da Embarcação</FormLabel>
                                            <FormControl>
                                                <ImageUpload
                                                    value={field.value || ""}
